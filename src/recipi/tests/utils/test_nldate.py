...
from recipi.utils.nldate import parse
...
class TestStaticParser(TestCase):
    ...
    def test_tomorrow(self):
        self.assertEqual(parse('tomorrow', default=self.default).date,
                         datetime(2003, 9, 26))

    def test_yesterday(self):
        self.assertEqual(parse('yesterday', default=self.default).date,
                         datetime(2003, 9, 24))

    def test_today(self):
        self.assertEqual(parse('today', default=self.default).date,
                         datetime(2003, 9, 25))

    def test_tonight(self):
        self.assertEqual(parse('tonight', default=self.default).date,
                         datetime(2003, 9, 25, 22))

    def test_next_friday(self):
        self.assertEqual(parse('next fri', default=self.default).date,
                         datetime(2003, 9, 26))
        self.assertEqual(parse('fri', default=self.default).date,
                         datetime(2003, 9, 26))

    def test_next_monday(self):
        self.assertEqual(parse('next mond', default=self.default).date,
                         datetime(2003, 9, 29))

    def test_yesterday_2pm(self):
        self.assertEqual(parse('yesterday 2pm', default=self.default).date,
                         datetime(2003, 9, 24, 14, 0))

    def test_tom_4_30(self):
        self.assertEqual(parse('tom at 16:30', default=self.default).date,
                         datetime(2003, 9, 26, 16, 30))

    def test_fr_2_pm(self):
        self.assertEqual(parse('fri at 2pm', default=self.default).date,
                         datetime(2003, 9, 26, 14, 00))

    def test_10(self):
        self.assertEqual(parse('10', default=self.default).date,
                         datetime(2003, 9, 10, 0, 0))

    def test_corret_year_month_day_ordering(self):
        self.assertEqual(parse('10/5', default=self.default).date,
                         datetime(2003, 10, 5, 0, 0))
        self.assertEqual(parse('10/5/2006 at 2pm', default=self.default).date,
...
class TestRecursionParser(TestCase):
    ...
    def test_every_day(self):
        r = parse('ev day', default=datetime(2003, 9, 9)).rule
    ...
    def test_every_mon_fri_20_pm(self):
        r = parse('every mon, fri at 20:00', default=datetime(2011, 5, 10)).rule
        self.assertEqual(
    ...
    def test_every_day_1pm(self):
        r = parse('every day at 1pm', default=datetime(2011, 5, 10)).rule
        self.assertEqual(
    ...
    def test_every_weekday(self):
        r = parse('every weekday', default=datetime(2011, 5, 10)).rule
        self.assertEqual(
        ...
        r = parse('every wday', default=datetime(2011, 5, 10)).rule
        self.assertEqual(
            r.between(datetime(2011, 5, 10), datetime(2011, 5, 20)),
            [
                datetime(2011, 5, 11, 0, 0),
...
class DateUtilCompatibilityParserTest(TestCase):
    ...
    def testDateCommandFormatStrip1(self):
        self.assertEqual(parse("Thu Sep 25 10:36:28 2003").date,
                         datetime(2003, 9, 25, 10, 36, 28))

    def testDateCommandFormatStrip2(self):
        self.assertEqual(parse("Thu Sep 25 10:36:28", default=self.default).date,
                         datetime(2003, 9, 25, 10, 36, 28))

    def testDateCommandFormatStrip3(self):
        self.assertEqual(parse("Thu Sep 10:36:28", default=self.default).date,
                         datetime(2003, 9, 25, 10, 36, 28))

    def testDateCommandFormatStrip4(self):
        self.assertEqual(parse("Thu 10:36:28", default=self.default).date,
                         datetime(2003, 9, 25, 10, 36, 28))

    def testDateCommandFormatStrip5(self):
        self.assertEqual(parse("Sep 10:36:28", default=self.default).date,
                         datetime(2003, 9, 25, 10, 36, 28))

    def testDateCommandFormatStrip6(self):
        self.assertEqual(parse("10:36:28", default=self.default).date,
                         datetime(2003, 9, 25, 10, 36, 28))

    def testDateCommandFormatStrip7(self):
        self.assertEqual(parse("10:36", default=self.default).date,
                         datetime(2003, 9, 25, 10, 36))

    def testDateCommandFormatStrip8(self):
        self.assertEqual(parse("Thu Sep 25 2003").date,
                         datetime(2003, 9, 25))

    def testDateCommandFormatStrip9(self):
        self.assertEqual(parse("Sep 25 2003").date,
                         datetime(2003, 9, 25))

    def testDateCommandFormatStrip10(self):
        self.assertEqual(parse("Sep 2003", default=self.default).date,
                         datetime(2003, 9, 25))

    def testDateCommandFormatStrip11(self):
        self.assertEqual(parse("Sep", default=self.default).date,
                         datetime(2003, 9, 25))

    def testDateCommandFormatStrip12(self):
        self.assertEqual(parse("2003", default=self.default).date,
                         datetime(2003, 9, 25))

    def testDateRCommandFormat(self):
        self.assertEqual(parse("Thu, 25 Sep 2003 10:49:41 -0300").date,
                         datetime(2003, 9, 25, 10, 49, 41,
                                  tzinfo=self.brsttz))

    def testISOFormat(self):
        self.assertEqual(parse("2003-09-25T10:49:41.5-03:00").date,
                         datetime(2003, 9, 25, 10, 49, 41, 500000,
                                  tzinfo=self.brsttz))

    def testISOFormatStrip1(self):
        self.assertEqual(parse("2003-09-25T10:49:41-03:00").date,
                         datetime(2003, 9, 25, 10, 49, 41,
                                  tzinfo=self.brsttz))

    def testISOFormatStrip2(self):
        self.assertEqual(parse("2003-09-25T10:49:41").date,
                         datetime(2003, 9, 25, 10, 49, 41))

    def testISOFormatStrip3(self):
        self.assertEqual(parse("2003-09-25T10:49").date,
                         datetime(2003, 9, 25, 10, 49))

    def testISOFormatStrip4(self):
        self.assertEqual(parse("2003-09-25T10").date,
                         datetime(2003, 9, 25, 10))

    def testISOFormatStrip5(self):
        self.assertEqual(parse("2003-09-25").date,
                         datetime(2003, 9, 25))

    def testISOStrippedFormat(self):
        self.assertEqual(parse("20030925T104941.5-0300").date,
                         datetime(2003, 9, 25, 10, 49, 41, 500000,
                                  tzinfo=self.brsttz))

    def testISOStrippedFormatStrip1(self):
        self.assertEqual(parse("20030925T104941-0300").date,
                         datetime(2003, 9, 25, 10, 49, 41,
                                  tzinfo=self.brsttz))

    def testISOStrippedFormatStrip2(self):
        self.assertEqual(parse("20030925T104941").date,
                         datetime(2003, 9, 25, 10, 49, 41))

    def testISOStrippedFormatStrip3(self):
        self.assertEqual(parse("20030925T1049").date,
                         datetime(2003, 9, 25, 10, 49, 0))

    def testISOStrippedFormatStrip4(self):
        self.assertEqual(parse("20030925T10").date,
                         datetime(2003, 9, 25, 10))

    def testISOStrippedFormatStrip5(self):
        self.assertEqual(parse("20030925").date,
                         datetime(2003, 9, 25))

    def testNoSeparator1(self):
        self.assertEqual(parse("199709020908").date,
                         datetime(1997, 9, 2, 9, 8))

    def testNoSeparator2(self):
        self.assertEqual(parse("19970902090807").date,
    ...
    def testDateWithDash2(self):
        self.assertEqual(parse("2003-Sep-25").date,
                         datetime(2003, 9, 25))

    def testDateWithDash3(self):
        self.assertEqual(parse("25-Sep-2003").date,
                         datetime(2003, 9, 25))
    ...
    def testDateWithDash6(self):
        self.assertEqual(parse("09-25-2003").date,
                         datetime(2003, 9, 25))

    def testDateWithDash7(self):
        self.assertEqual(parse("25-09-2003").date,
                         datetime(2003, 9, 25))

    def testDateWithDash8(self):
        self.assertEqual(parse("10-09-2003", dayfirst=True).date,
                         datetime(2003, 9, 10))

    def testDateWithDash9(self):
        self.assertEqual(parse("10-09-2003").date,
                         datetime(2003, 10, 9))

    def testDateWithDash10(self):
        self.assertEqual(parse("10-09-03").date,
                         datetime(2003, 10, 9))

    def testDateWithDash11(self):
        self.assertEqual(parse("10-09-03", yearfirst=True).date,
                         datetime(2010, 9, 3))
    ...
    def testDateWithSpace12(self):
        self.assertEqual(parse("25 09 03").date,
                         datetime(2003, 9, 25))
    ...
    def testStrangelyOrderedDate1(self):
        self.assertEqual(parse("03 25 Sep").date,
                         datetime(2003, 9, 25))

    def testStrangelyOrderedDate2(self):
        self.assertEqual(parse("2003 25 Sep").date,
                         datetime(2003, 9, 25))

    def testStrangelyOrderedDate3(self):
        self.assertEqual(parse("25 03 Sep").date,
                         datetime(2025, 9, 3))

    def testHourWithLetters(self):
        self.assertEqual(parse("10h36m28.5s", default=self.default).date,
                         datetime(2003, 9, 25, 10, 36, 28, 500000))

    def testHourWithLettersStrip1(self):
        self.assertEqual(parse("10h36m28s", default=self.default).date,
                         datetime(2003, 9, 25, 10, 36, 28))

    def testHourWithLettersStrip2(self):
        self.assertEqual(parse("10h36m", default=self.default).date,
                         datetime(2003, 9, 25, 10, 36))

    def testHourWithLettersStrip3(self):
        self.assertEqual(parse("10h", default=self.default).date,
                         datetime(2003, 9, 25, 10))

    def testHourAmPm1(self):
        self.assertEqual(parse("10h am", default=self.default).date,
                         datetime(2003, 9, 25, 10))

    def testHourAmPm2(self):
        self.assertEqual(parse("10h pm", default=self.default).date,
                         datetime(2003, 9, 25, 22))

    def testHourAmPm3(self):
        self.assertEqual(parse("10am", default=self.default).date,
                         datetime(2003, 9, 25, 10))

    def testHourAmPm4(self):
        self.assertEqual(parse("10pm", default=self.default).date,
                         datetime(2003, 9, 25, 22))

    def testHourAmPm5(self):
        self.assertEqual(parse("10:00 am", default=self.default).date,
                         datetime(2003, 9, 25, 10))

    def testHourAmPm6(self):
        self.assertEqual(parse("10:00 pm", default=self.default).date,
                         datetime(2003, 9, 25, 22))

    def testHourAmPm7(self):
        self.assertEqual(parse("10:00am", default=self.default).date,
                         datetime(2003, 9, 25, 10))

    def testHourAmPm8(self):
        self.assertEqual(parse("10:00pm", default=self.default).date,
                         datetime(2003, 9, 25, 22))

    def testHourAmPm9(self):
        self.assertEqual(parse("10:00a.m", default=self.default).date,
                         datetime(2003, 9, 25, 10))

    def testHourAmPm10(self):
        self.assertEqual(parse("10:00p.m", default=self.default).date,
                         datetime(2003, 9, 25, 22))
    ...
    def testPertain(self):
        self.assertEqual(parse("Sep 03", default=self.default).date,
                         datetime(2003, 9, 3))
        self.assertEqual(parse("Sep of 03", default=self.default).date,
                         datetime(2003, 9, 25))

    def testWeekdayAlone(self):
        self.assertEqual(parse("Wed", default=self.default).date,
                         datetime(2003, 10, 1))

    def testLongWeekday(self):
        self.assertEqual(parse("Wednesday", default=self.default).date,
                         datetime(2003, 10, 1))

    def testLongMonth(self):
        self.assertEqual(parse("October", default=self.default).date,
                         datetime(2003, 10, 25))

    def testZeroYear(self):
        self.assertEqual(parse("31-Dec-00", default=self.default).date,
                         datetime(2000, 12, 31))

    def testFuzzy(self):
        s = "Today is 25 of September of 2003, exactly " \
            "at 10:49:41 with timezone -03:00."
        self.assertEqual(parse(s, fuzzy=True).date,
                         datetime(2003, 9, 25, 10, 49, 41,
                                  tzinfo=self.brsttz))

    def testExtraSpace(self):
        self.assertEqual(parse("  July   4 ,  1976   12:01:02   am  ").date,
                         datetime(1976, 7, 4, 0, 1, 2))

    def testRandomFormat1(self):
        self.assertEqual(parse("Wed, July 10, '96").date,
    ...
    def testRandomFormat3(self):
        self.assertEqual(parse("1996.July.10 AD 12:08 PM").date,
    ...
    def testRandomFormat8(self):
        self.assertEqual(parse("July 4, 1976").date, datetime(1976, 7, 4))

    def testRandomFormat9(self):
        self.assertEqual(parse("7 4 1976").date, datetime(1976, 7, 4))

    def testRandomFormat10(self):
        self.assertEqual(parse("4 jul 1976").date, datetime(1976, 7, 4))

    def testRandomFormat11(self):
        self.assertEqual(parse("7-4-76").date, datetime(1976, 7, 4))

    def testRandomFormat12(self):
        self.assertEqual(parse("19760704").date, datetime(1976, 7, 4))

    def testRandomFormat13(self):
        self.assertEqual(parse("0:01:02", default=self.default).date,
                         datetime(2003, 9, 25, 0, 1, 2))

    def testRandomFormat14(self):
        self.assertEqual(parse("12h 01m02s am", default=self.default).date,
                         datetime(2003, 9, 25, 0, 1, 2))

    def testRandomFormat15(self):
        self.assertEqual(parse("0:01:02 on July 4, 1976").date,
                         datetime(1976, 7, 4, 0, 1, 2))
    ...
    def testRandomFormat17(self):
        self.assertEqual(parse("1976-07-04T00:01:02Z", ignoretz=True).date,
                         datetime(1976, 7, 4, 0, 1, 2))
    ...
    def testRandomFormat19(self):
        self.assertEqual(parse("Mon Jan  2 04:24:27 1995").date,
                         datetime(1995, 1, 2, 4, 24, 27))

    def testRandomFormat20(self):
        self.assertEqual(parse("Tue Apr 4 00:22:12 PDT 1995", ignoretz=True).date,
                         datetime(1995, 4, 4, 0, 22, 12))

    def testRandomFormat21(self):
        self.assertEqual(parse("04.04.95 00:22").date,
                         datetime(1995, 4, 4, 0, 22))

    def testRandomFormat22(self):
        self.assertEqual(parse("Jan 1 1999 11:23:34.578").date,
                         datetime(1999, 1, 1, 11, 23, 34, 578000))

    def testRandomFormat23(self):
        self.assertEqual(parse("950404 122212").date,
    ...
    def testRandomFormat25(self):
        self.assertEqual(parse("12:08 PM", default=self.default).date,
                         datetime(2003, 9, 25, 12, 8))

    def testRandomFormat26(self):
        self.assertEqual(parse("5:50 A.M. on June 13, 1990").date,
                         datetime(1990, 6, 13, 5, 50))

    def testRandomFormat27(self):
        self.assertEqual(parse("3rd of May 2001").date, datetime(2001, 5, 3))

    def testRandomFormat28(self):
        self.assertEqual(parse("5th of March 2001").date, datetime(2001, 3, 5))

    def testRandomFormat29(self):
        self.assertEqual(parse("1st of May 2003").date, datetime(2003, 5, 1))

    def testRandomFormat30(self):
        self.assertEqual(parse("01h02m03", default=self.default).date,
                         datetime(2003, 9, 25, 1, 2, 3))

    def testRandomFormat31(self):
        self.assertEqual(parse("01h02", default=self.default).date,
                         datetime(2003, 9, 25, 1, 2))

    def testRandomFormat32(self):
        self.assertEqual(parse("01h02s", default=self.default).date,
                         datetime(2003, 9, 25, 1, 0, 2))

    def testRandomFormat33(self):
        self.assertEqual(parse("01m02", default=self.default).date,
                         datetime(2003, 9, 25, 0, 1, 2))

    def testRandomFormat34(self):
        self.assertEqual(parse("01m02h", default=self.default).date,
                         datetime(2003, 9, 25, 2, 1))

    def testRandomFormat35(self):
        self.assertEqual(parse("2004 10 Apr 11h30m", default=self.default).date,
    ...
    def testIncreasingCTime(self):
        ...
        for i in range(200):
            self.assertEqual(parse(dt.ctime()).date, dt)
            dt += delta
    ...
    def testIncreasingISOFormat(self):
        ...
        dt = datetime(1900, 1, 1, 0, 0, 0, 0)
        for i in range(200):
            self.assertEqual(parse(dt.isoformat()).date, dt)
            dt += delta

    def testMicrosecondsPrecisionError(self):
        # Skip found out that sad precision problem. :-(
        dt1 = parse("00:11:25.01").date
        dt2 = parse("00:12:10.01").date
    ...
    def testMicrosecondPrecisionErrorReturns(self):
        ...
        for ms in data:
            ...
            self.assertEquals(parse(dt.isoformat()).date, dt)

    def testHighPrecisionSeconds(self):
        self.assertEquals(parse("20080227T21:26:01.123456789").date,
